...
let graphicsGrid = new Array(gridWidth).fill(0).map(() => new Array(gridHeight).fill(0));
let lifeTime = 1;
let fadeSlider = document.getElementById("fade-slider");
